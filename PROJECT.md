...
| 1 | `1×1` | **黑猫（彩蛋）** | 手写 SVG **趴卧黑猫**（照小潘给的参考图：暖调炭黑毛 `#302D26` + **黄绿眼** `#C6D74F` + 短圆耳 + 深色鼻嘴胡须；**无项圈/铃铛/腮红/白肚子**）：视线跟随鼠标、点一下眯眼笑、**连点 7 次触发彩蛋**（爱心/星星/爪印两轮齐飞）；卡片底色改成**奶油米色** `#F8F4EB → #E9E1D2`（刻意不留 `dark:` 分支）；**见 4.7.16** |
